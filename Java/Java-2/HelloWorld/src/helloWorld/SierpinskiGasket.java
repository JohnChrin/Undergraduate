package helloWorld;
/* Program - Class Sierpinski Gasket
Name: John A Chrin

The Sierpinski triangle, 
also called the Sierpinski gasket or the Sierpinski sieve, 
...
public class SierpinskiGasket extends JApplet
{
   ...
   public void init()
   {
	   // A request to the user to enter how many levels of recursion to go through to generate the triangle picture.
