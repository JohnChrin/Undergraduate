...
public class ListCat extends JFrame {
  final int NUMBER_OF_CATS = 4;

  // Declare an array of Strings for flag titles
  private String[] catTitles = {"Happy Cat", "Tired Cat", "Suprised Cat", "Praying Cat"};
